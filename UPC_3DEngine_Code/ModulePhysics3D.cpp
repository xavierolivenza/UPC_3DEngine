...
{
	LOGP("Creating 3D Physics simulation");
	bool ret = true;
...
{
	LOGP("Creating Physics environment");
...
{
	LOGP("Destroying 3D Physics simulation");
...
// ---------------------------------------------------------
PhysBody3D* ModulePhysics3D::AddBody(const P2Sphere& sphere, float mass)
{
...
// ---------------------------------------------------------
PhysBody3D* ModulePhysics3D::AddBody(const P2Cylinder& cylinder, float mass)
{
...
{
	LOGP("Bullet warning: %s", warningString);
}

void DebugDrawer::draw3dText(const btVector3& location, const char* textString)
{
	LOGP("Bullet draw text: %s", textString);
}
